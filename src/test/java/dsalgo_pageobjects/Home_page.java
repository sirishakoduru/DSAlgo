...
public class Home_page {
	...
	//1.By locators
	@FindBy (xpath = "//h1[text()='Preparing for the Interviews']") WebElement Startpage;
	...
	@FindBy(xpath = "//a[@class='dropdown-item']") List<WebElement> dropDownOptions;
	@FindBy (xpath = "//a[@href='/array']") WebElement dropdown_Arrays;
	...
	//@Getstarted button
	@FindBy (xpath = "//a[@href='data-structures-introduction']") WebElement getstarted_datastructures;
	...
	@FindBy (xpath = "//div[@class='card h-100']") List<WebElement> DScards;
